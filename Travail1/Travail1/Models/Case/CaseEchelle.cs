...
namespace Travail1.Models.Case
{
    class CaseEchelle : CaseBase
    {
        ...
        public override void Dessiner(Graphics graphics)
        {
            ...
            graphics.DrawRectangle(Pens.Gray, coordonees.X, coordonees.Y, Largeur, Largeur);
            graphics.DrawString((Position + 1).ToString(), font, Brushes.Gray, coordonees.X + 30, coordonees.Y + 30);
